...
class AccountPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: FutureBuilder(future:authController.getDocId(authController.firebaseUser.value!.email.toString()),builder:(context,snapshot){
        ...
        if(snapshot.connectionState ==ConnectionState.done){
          ...
          if(snapshot.hasData){
                  ...
                  SizedBox(
                    ...
                    child: SingleChildScrollView(
                      child: Column(children: [
                        ...
                        //   height: Dimensions.width30,
                        // ),
                        GestureDetector(onTap:(){ AuthController.instance.signOut();},
                          child: AccountWidget(
                            appIcon: AppIcon(
            ...
            return Center(child: BigText(text: 'Something went wrong',)
            );
          }
        }else{
